...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        # x = F.relu(F.max_pool2d(self.conv1(x), 3))  # in : torch.Size([1600, 256, 30, 40]) out :torch.Size([1600, 128, 9, 12])
...
class CnnModule(nn.Module):
    ...
    def forward(self, x):
        ...
        # x = F.adaptive_avg_pool2d(x, (1, 1)) # in: torch.Size([1600, 512, 1, 1]) out: torch.Size([1600, 512, 1, 1])
...
class CNN_LSTM(nn.Module):
    ...
    def forward(self, x):
        ...
        # tag_score = self.soft(tag_score) # in: torch.Size([8, 200, 13]) out: torch.Size([8, 200, 13])
