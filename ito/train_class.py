...
def validation(epoch, best_pred, best_loss):
    ...
    # torch.save(model.state_dict(), "./model_weigth/cnn_lstm/weight_epoc{}.pth".format(epoch + start_epoc+ 1))
    if epoch % 10 == 0:
        torch.save(model.state_dict(), "./model_weigth/cnn_lstm/weight_epoc{}.pth".format(epoch +  1))
